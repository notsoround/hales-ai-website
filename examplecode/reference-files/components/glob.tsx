...
const AbstractBall: React.FC<AbstractBallProps> = ({
  ...
  useEffect(() => {
    ...
    const geometry = new THREE.IcosahedronGeometry(6.67, 20); // Reduced to 1/3 of original size (20/3)

    // Define shaders directly in the component instead of fetching from DOM
    const vertexShader = `
