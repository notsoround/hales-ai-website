...
export type DashboardEntry = { id: string; type: string; date: string; time?: string; title: string; body?: string; amount?: number | null; calories?: number | null; parentId?: string | null; source?: string; icon?: string; details?: { mealId?: string | null; outcome?: unknown; boughtAnyway?: unknown; [key: string]: unknown } };
